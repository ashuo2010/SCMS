  ...
  <div>
    ...
    >
      <el-table :data="itemDetail" stripe style="width: 100%">
        ...
        <el-table-column label="项目性别" prop="itemSex" width="80">
        </el-table-column>
        <el-table-column label="项目地点" prop="itemPlace" width="80">
        </el-table-column>
        ...
        <el-table-column label="项目结束时间" prop="endTime" width="140">
        </el-table-column>
        <el-table-column label="项目参赛人数" prop="athleteAmount" width="100">
        </el-table-column>
        <el-table-column label="项目创建时间" prop="createTime" width="140">
        </el-table-column>
        <el-table-column label="项目修改时间" prop="editTime" width="140">
        </el-table-column>
      </el-table>
    </el-dialog>
